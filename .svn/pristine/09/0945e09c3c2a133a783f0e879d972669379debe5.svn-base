...
class ocTree{
	...
	public:
		 ...
		 * recursively traverses through the tree until the correct leaf node (containing x,y,z) is found
		 ...
		 */
		ocTree* addVerticesToSelectionByCoordinates(float x, float y, float z, float radius, std::set<size_t> &intermediateSelection, bool debugInfo);
		 ...
		 */
		ocTree* removeVerticesFromSelectionByCoordinates (float x, float y, float z, float radius, std::set<size_t> &intermediateSelection, bool debugInfo);
