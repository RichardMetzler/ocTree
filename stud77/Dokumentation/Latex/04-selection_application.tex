...
\begin{description}
	...
	\item[\texttt{void debugIdentifierasString()}] - prints the boolean identify array of the calling subtree to the console in an easily readable form, i.e. 001101 for example. If the calling node is the root, "I am root" is printed instead. Additionally, \texttt{m\_level} as well as the identifier array of the parent node of the calling subtree node are printed.
\end{description}
