...
//	ocTreeLeaf * testNodeCo = myOcTree->getNodeByCoordinates(-1.58f,0.88f,-1.65f, 0.05f, true);
	// ocTreeLeaf * testNodeCo = myOcTree->getNodeByCoordinates(-1.58f,1.0f,-1.65f, 0.1f, true);

// @FIXME: If the following line does not work, the function does not return what it should return
//	std::cout << "testNOdeCo.m_level: " << testNodeCo->getLevel() << std::endl;
