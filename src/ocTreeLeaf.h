...
class ocTreeLeaf {
	...
	private:
		...
		std::vector<std::pair<size_t, glm::vec3> > m_verticesInBounds3;
...
//		bool same_coordinates (glm::vec3 frst, glm::vec3 scnd);
		 ...
		 *
		 * @PARAM std::vector<glm::vec3> inputVector - input vector of vertices
		 * @RETURN std::vector<std::pair<size_t, glm::vec3>> - output ordered list of vertices
		 */
		// std::vector<std::pair<size_t, glm::vec3>> convertVectorToList(std::vector<glm::vec3> inputVector);
